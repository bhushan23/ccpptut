...
EXTRACT=extract
EXTRACT_OBJECTS=Extract.o Node.o Operation.o
FILTER=filter
FILTER_OBJECTS=Filter.o InputParser.o
PLUGIN=harvest.so
PLUGIN_OBJECTS=Harvest.o Node.o Operation.o
PRINT=print
PRINT_OBJECTS=Node.o Operation.o Print.o
SIMPLIFY=simplify
